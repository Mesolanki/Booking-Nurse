              ...
              <div className="dropdown ms-3">
                ...
                <ul className="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                  <li className="px-3 py-2 border-bottom">
                    ...
                    <small className="d-block text-muted">{profile.email}</small>
                    <small className="d-block text-muted">{profile.type}</small>
                  </li>

                  <li>
                    <Link className="dropdown-item d-flex align-items-center gap-2" to="/update-profile">
                      <Settings size={16} /> Update Profile
                    </Link>
                  </li>

                  <li>
                    <Link className="dropdown-item d-flex align-items-center gap-2" to="/schedule">
