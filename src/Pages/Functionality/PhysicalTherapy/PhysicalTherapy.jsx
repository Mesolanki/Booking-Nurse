...
const PhysicalTherapy = () => {
    ...
    const fetchNurses = async () => {
        try {
            ...
            // Filter to only show nurses in the "Physical Therapy" category
            const physicalTherapyNurses = res.data.filter(nurse =>
                nurse.category === "Physical Therapy Assistance"
            );

            setNurses(physicalTherapyNurses);
        } catch (error) {
    ...
    return (
        <section className="py-5 bg-white">
            <Hero title="Physical Therapy" currentPage="Physical Therapy" />
