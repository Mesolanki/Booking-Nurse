...
const IllnessManagement = () => {
    ...
    const fetchNurses = async () => {
        try {
            ...
            // Filter to only show nurses in the "Illness Management" category
            const illnessManagementNurses = res.data.filter(nurse =>
                nurse.category === "Illness Management"
            );

            setNurses(illnessManagementNurses);
        } catch (error) {
    ...
    return (
        <section className="py-5 bg-white">
            <Hero title="Illness Management" currentPage="Illness Management" />
