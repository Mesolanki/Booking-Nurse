...
const PallativeCare = () => {
    ...
    const fetchNurses = async () => {
        try {
            ...
            // Filter to only show nurses in the "Palliative Care" category
            const palliativeCareNurses = res.data.filter(nurse =>
                nurse.category === "Palliative Care"
            );

            setNurses(palliativeCareNurses);
        } catch (error) {
    ...
    return (
        <section className="py-5 bg-white">
            <Hero title="Palliative Care" currentPage="Palliative Care" />
                            ...
                            <div key={nurse.id} className="col-md-6 col-lg-4">
                                <div className="card h-100 border-0 shadow-sm rounded-4 overflow-hidden animate-card">
                                    ...
                                    <div className="card-body p-4">
                                        ...
                                        <button className="btn btn-outline-primary w-100 rounded-pill py-2 fw-bold d-flex align-items-center justify-content-center gap-2" onClick={() => navigate(`/book-nurse/appointment`)} >
