...
const PostSurgery = () => {
    ...
    const fetchNurses = async () => {
        try {
            ...
            // Filter to only show nurses in the "Post Surgery" category
            const postSurgeryNurses = res.data.filter(nurse =>
                nurse.category === "Post Surgery"
            );

            setNurses(postSurgeryNurses);
        } catch (error) {
    ...
    return (
        <section className="py-5 bg-white">
            <Hero title="Post Surgery" currentPage="Post Surgery" />
